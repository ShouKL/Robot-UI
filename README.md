...
| dependency | link | System Variable | Value | Env Variables |
|------------|------|-----------------|-------|---------------|
| OpenCV | https://opencv.org/releases/ Windows| OPENCV | ...\opencv\build | ...\opencv\build\x64\vc16\bin |
| gstreamer | https://gstreamer.freedesktop.org/download/#windows MSVC x86_64 (VS 2022, Release CRT)| GSTREAMER | ...\gstreamer\1.0\msvc_x86_64 | ...\gstreamer\1.0\msvc_x86_64\bin |
| Vulkan | https://vulkan.lunarg.com/sdk/home vulkansdk-windows-X64-1.4.341.1.exe | VULKAN_SDK | ...\VulkanSDK\1.4.341.1 |  |
| Mujoco | https://github.com/google-deepmind/mujoco/releases mujoco-3.8.0-windows-x86_64.zip | MUJOCO | ...\mujoco | ...\mujoco\bin |
